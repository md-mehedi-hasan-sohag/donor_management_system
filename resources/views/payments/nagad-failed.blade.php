...
<div class="failed-container">
    ...
    <div class="failed-card">
        ...
        <p style="color: var(--gray-600); font-size: 1.125rem; margin-bottom: 2rem;">
            We couldn't process your Nagad payment
        </p>
        ...
        <div class="common-reasons">
            ...
            <ul>
                <li>Insufficient balance in Nagad account</li>
                <li>Incorrect Nagad PIN entered</li>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            <a href="{{ route('nagad.payment', $campaign) }}" class="btn btn-primary" style="flex: 1;">
                Try Again
            </a>
