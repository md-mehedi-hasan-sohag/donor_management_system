...
<style>
    ...
    .nagad-header {
        background: linear-gradient(135deg, #E93E3A 0%, #D62828 100%);
        color: white;
        padding: 2rem;
        text-align: center;
    }
    ...
    .payment-input input:focus {
        outline: none;
        border-color: #E93E3A;
        box-shadow: 0 0 0 3px rgba(233, 62, 58, 0.1);
    }
    ...
    .btn-nagad:hover {
        ...
        box-shadow: 0 6px 20px rgba(233, 62, 58, 0.4);
    }
...
<div class="nagad-container">
    <div class="nagad-card">
        ...
        <div class="nagad-body">
            ...
            <!-- Payment Form -->
            <form action="{{ route('nagad.process', $campaign) }}" method="POST" id="nagadForm">
                @csrf
                ...
                <div class="payment-input">
                    ...
                    <input
                        ...
                        value="{{ old('phone') }}"
                    >
                    <div class="input-hint">Enter your 11-digit Nagad mobile number</div>
                    @error('phone')
                ...
                <div class="payment-input">
                    ...
                    <input
                        ...
                        required
                    >
                    <div class="input-hint">Enter your 4-digit Nagad PIN</div>
                    @error('pin')
                        <div style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</div>
                    @enderror
                </div>

                <button type="submit" class="btn-nagad" id="payButton">
            ...
            <div class="security-info">
                ...
                This is a simulated Nagad payment for demonstration purposes. Your actual Nagad account will not be charged.
            </div>
        </div>
    </div>
</div>
...
<script>
document.getElementById('nagadForm').addEventListener('submit', function() {
